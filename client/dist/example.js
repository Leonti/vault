...
(function(exports) {
  ...
  var renderNote = function (v) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mdc-card") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(v.title) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(v.content) ]) ]);
  };
  ...
  var renderVault = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Passwords") ]), renderCredentialList(v.credentials), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Notes") ]), renderNoteList(v.notes) ]);
  };
  var render = function (st) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(st.password), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputPassword.value), Halogen_HTML_Properties.autocomplete(false), Halogen_HTML_Properties.id_("some_random"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetPassword.create)), Halogen_HTML_Properties.class_("mdc-text-field__input") ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(st.loading), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(MakeRequest.create)) ])([ Halogen_HTML_Core.text("Fetch info") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text((function () {
          if (st.loading) {
              return "Working...";
          };
          return "";
          ...
          if (st.vault instanceof Data_Maybe.Just) {
              return [ renderVault(st.vault.value0) ];
          };
          throw new Error("Failed pattern match at Component line 97, column 9 - line 100, column 34: " + [ st.vault.constructor.name ]);
      })()), Halogen_HTML_Elements.div_((function () {
          if (st.error instanceof Data_Maybe.Nothing) {
              return [  ];
          };
          if (st.error instanceof Data_Maybe.Just) {
              return [ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Error:") ]), Halogen_HTML_Elements.pre_([ Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text(st.error.value0) ]) ]) ];
          };
          throw new Error("Failed pattern match at Component line 102, column 9 - line 109, column 14: " + [ st.error.constructor.name ]);
      })()) ]);
  };
  var initialState = {
      loading: false,
  ...
  var getVault = function (password) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableJson)((function () {
          ...
          $21.url = "http://localhost:3000/db/1";
          $21.headers = [ new Network_HTTP_RequestHeader.RequestHeader("Authorization", "Basic " + Data_String_Base64.encode("vault:" + password)) ];
          return $21;
      })())))(function (v) {
          var decode = function (r) {
              return Data_Argonaut_Decode_Class.decodeJson(Vault.decodeJsonVault)(r.response);
          };
          var vault = Data_Either.either(function ($46) {
              return Data_Either.Left.create(Control_Monad_Eff_Exception.message($46));
          })(decode)(v);
  ...
  var $$eval = function (v) {
      if (v instanceof SetPassword) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $26.password = v.value0;
              $26.vault = Data_Maybe.Nothing.value;
              return $26;
          }))(function () {
      ...
      if (v instanceof MakeRequest) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(getVault(v1)))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          if (v2 instanceof Data_Either.Right) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  $37.loading = false;
                                  $37.vault = new Data_Maybe.Just(v2.value0);
                                  return $37;
                              });
                          };
                          if (v2 instanceof Data_Either.Left) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  $41.loading = false;
                                  $41.error = new Data_Maybe.Just(v2.value0);
                                  return $41;
                              });
                          };
                          throw new Error("Failed pattern match at Component line 124, column 5 - line 126, column 65: " + [ v2.constructor.name ]);
                      })())(function () {
      ...
      throw new Error("Failed pattern match at Component line 116, column 8 - line 127, column 14: " + [ v.constructor.name ]);
  };
