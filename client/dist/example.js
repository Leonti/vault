...
(function(exports) {
  ...
  var Data_Char_Utils = PS["Data.Char.Utils"];
  var Data_Functor = PS["Data.Functor"];
...
(function(exports) {
  ...
  var Data_Newtype = PS["Data.Newtype"];
  var Prelude = PS["Prelude"];
  var Vault = function (x) {
      return x;
  };
  var CredentialEntry = (function () {
      function CredentialEntry(value0) {
          this.value0 = value0;
      };
      CredentialEntry.create = function (value0) {
          return new CredentialEntry(value0);
      };
      return CredentialEntry;
  })();
  var NoteEntry = (function () {
      function NoteEntry(value0) {
          this.value0 = value0;
      };
      NoteEntry.create = function (value0) {
          return new NoteEntry(value0);
      };
      return NoteEntry;
  })();
  var decodeJsonNote = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
  ...
  var decodeJsonCredential = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("id"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("username"))(function (v2) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("password"))(function (v3) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)({
                          id: v1,
                          username: v2,
                          password: v3
  ...
  var decodeJsonVault = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(decodeJsonCredential))(v)("credentials"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(decodeJsonNote))(v)("notes"))(function (v2) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)({
                      credentials: v1,
                      notes: v2
                  });
  ...
  exports["Vault"] = Vault;
  exports["CredentialEntry"] = CredentialEntry;
  exports["NoteEntry"] = NoteEntry;
  exports["decodeJsonCredential"] = decodeJsonCredential;
  exports["decodeJsonNote"] = decodeJsonNote;
  exports["decodeJsonVault"] = decodeJsonVault;
})(PS["Vault"] = PS["Vault"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  ...
  var Prelude = PS["Prelude"];
  var Vault = PS["Vault"];        
  var getVault = function (password) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableJson)((function () {
          var $2 = {};
          ...
          $2.url = "http://localhost:3000/db/1";
          $2.headers = [ new Network_HTTP_RequestHeader.RequestHeader("Authorization", "Basic " + Data_String_Base64.encode("vault:" + password)) ];
          return $2;
      })())))(function (v) {
          var decode = function (r) {
              return Data_Argonaut_Decode_Class.decodeJson(Vault.decodeJsonVault)(r.response);
          };
          var vault = Data_Either.either(function ($6) {
              return Data_Either.Left.create(Control_Monad_Eff_Exception.message($6));
          })(decode)(v);
          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(vault);
      });
  };
...
(function(exports) {
  ...
  var retractFreeAp = function (dictApplicative) {
      return foldFreeAp(dictApplicative)(Control_Category.id(Control_Category.categoryFn));
  };
...
(function(exports) {
  ...
  // json-server --watch example.json
  var SetCredentialId = (function () {
      function SetCredentialId(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetCredentialId.create = function (value0) {
          return function (value1) {
              return new SetCredentialId(value0, value1);
          };
      };
      return SetCredentialId;
  })();

  // json-server --watch example.json
  var SetCredentialUsername = (function () {
      function SetCredentialUsername(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetCredentialUsername.create = function (value0) {
          return function (value1) {
              return new SetCredentialUsername(value0, value1);
          };
      };
      return SetCredentialUsername;
  })();

  // json-server --watch example.json
  var SetCredentialPassword = (function () {
      function SetCredentialPassword(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetCredentialPassword.create = function (value0) {
          return function (value1) {
              return new SetCredentialPassword(value0, value1);
          };
      };
  ...
  // json-server --watch example.json
  var SetNoteTitle = (function () {
      function SetNoteTitle(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetNoteTitle.create = function (value0) {
          return function (value1) {
              return new SetNoteTitle(value0, value1);
          };
      };
      return SetNoteTitle;
  })();
  ...
  var SetNoteContent = (function () {
      function SetNoteContent(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetNoteContent.create = function (value0) {
          return function (value1) {
              return new SetNoteContent(value0, value1);
          };
      };
  ...
  // json-server --watch example.json
  var GetVaultEntry = (function () {
      function GetVaultEntry(value0) {
          this.value0 = value0;
      };
      GetVaultEntry.create = function (value0) {
          return new GetVaultEntry(value0);
      };
      return GetVaultEntry;
  })();
  var updateNote = function (v) {
      return function (v1) {
          if (v1 instanceof Vault.NoteEntry) {
              return Vault.NoteEntry.create(v(v1.value0));
          };
          return v1;
      };
  };
  var updateCredential = function (v) {
      return function (v1) {
          if (v1 instanceof Vault.CredentialEntry) {
              return Vault.CredentialEntry.create(v(v1.value0));
          };
          return v1;
      };
  };
  var renderEditNoteForm = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mdc-text-field mdc-text-field--fullwidth") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(v.title), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.placeholder("Title"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetNoteTitle.create)), Halogen_HTML_Properties.class_("mdc-text-field__input") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mdc-text-field mdc-text-field--fullwidth mdc-text-field--textarea") ])([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.value(v.content), Halogen_HTML_Properties.id_("content"), Halogen_HTML_Properties.placeholder("Content"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetNoteContent.create)), Halogen_HTML_Properties.class_("mdc-text-field__input") ]) ]) ]);
  };
 ...
 * </div>
 */  
  var renderEditCredentialForm = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mdc-text-field mdc-text-field--fullwidth") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(v.id), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.placeholder("Id"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetCredentialId.create)), Halogen_HTML_Properties.class_("mdc-text-field__input") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mdc-text-field mdc-text-field--fullwidth") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(v.username), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.placeholder("Username"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetCredentialUsername.create)), Halogen_HTML_Properties.class_("mdc-text-field__input") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mdc-text-field mdc-text-field--with-trailing-icon mdc-text-field--fullwidth") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(v.password), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.placeholder("Password"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetCredentialPassword.create)), Halogen_HTML_Properties.class_("mdc-text-field__input") ]), Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("material-icons mdc-text-field__icon generate-password"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GeneratePassword.create)) ])([ Halogen_HTML_Core.text("autorenew") ]) ]) ]);
  };
 ...
 */  
  var render = function (st) {
      return Halogen_HTML_Elements.div_([ (function () {
          if (st.entry instanceof Vault.CredentialEntry) {
              return renderEditCredentialForm(st.entry.value0);
          };
          if (st.entry instanceof Vault.NoteEntry) {
              return renderEditNoteForm(st.entry.value0);
          };
          throw new Error("Failed pattern match at EditEntryComponent line 114, column 7 - line 116, column 44: " + [ st.entry.constructor.name ]);
      })() ]);
  };
  var initialState = function (entry) {
      return {
          entry: entry
      };
  };
  var $$eval = function (query) {
      if (query instanceof HandleInput) {
      ...
      if (query instanceof SetCredentialId) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              ...
              $49.entry = updateCredential(function (v1) {
                  var $46 = {};
                  for (var $47 in v1) {
      ...
      if (query instanceof SetCredentialUsername) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              var $58 = {};
              for (var $59 in st) {
              ...
              $58.entry = updateCredential(function (v1) {
                  var $55 = {};
                  for (var $56 in v1) {
      ...
      if (query instanceof SetCredentialPassword) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              var $67 = {};
              for (var $68 in st) {
              ...
              $67.entry = updateCredential(function (v1) {
                  var $64 = {};
                  for (var $65 in v1) {
      ...
      if (query instanceof GeneratePassword) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Random.random))(function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $77 = {};
                  for (var $78 in st) {
                  ...
                  $77.entry = updateCredential(function (v2) {
                      var $74 = {};
                      for (var $75 in v2) {
                      ...
                      $74.password = "random_password" + Data_Show.show(Data_Show.showNumber)(v);
                      return $74;
                  })(st.entry);
                  return $77;
              }))(function () {
      ...
      if (query instanceof SetNoteTitle) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              var $85 = {};
              for (var $86 in st) {
              ...
              $85.entry = updateNote(function (v1) {
                  var $82 = {};
                  for (var $83 in v1) {
      ...
      if (query instanceof SetNoteContent) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              var $94 = {};
              for (var $95 in st) {
              ...
              $94.entry = updateNote(function (v1) {
                  var $91 = {};
                  for (var $92 in v1) {
      ...
      if (query instanceof GetVaultEntry) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(query.value0(v));
          });
      };
      throw new Error("Failed pattern match at EditEntryComponent line 133, column 14 - line 158, column 23: " + [ query.constructor.name ]);
  };
  var ui = function (vaultEntry) {
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](initialState(vaultEntry)),
          render: render,
          "eval": $$eval,
  ...
  exports["SetCredentialId"] = SetCredentialId;
  exports["SetCredentialUsername"] = SetCredentialUsername;
  exports["SetCredentialPassword"] = SetCredentialPassword;
  exports["GeneratePassword"] = GeneratePassword;
  exports["SetNoteTitle"] = SetNoteTitle;
  exports["SetNoteContent"] = SetNoteContent;
  exports["GetVaultEntry"] = GetVaultEntry;
  exports["ui"] = ui;
})(PS["EditEntryComponent"] = PS["EditEntryComponent"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Data_Semigroup = PS["Data.Semigroup"];
  var Data_Void = PS["Data.Void"];
  var EditEntryComponent = PS["EditEntryComponent"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_HTML = PS["Halogen.HTML"];
  var Halogen_HTML_Core = PS["Halogen.HTML.Core"];
  ...
  var EditEntrySlot = (function () {
      function EditEntrySlot() {

      };
      EditEntrySlot.value = new EditEntrySlot();
      return EditEntrySlot;
  })();
  var SwitchTab = (function () {
      function SwitchTab(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SwitchTab.create = function (value0) {
          return function (value1) {
              return new SwitchTab(value0, value1);
          };
      };
      return SwitchTab;
  })();
  ...
  var SaveEntry = (function () {
      function SaveEntry(value0) {
          this.value0 = value0;
      };
      SaveEntry.create = function (value0) {
          return new SaveEntry(value0);
      };
      return SaveEntry;
  })();
  var CancelEdit = (function () {
      function CancelEdit(value0) {
          this.value0 = value0;
      };
      CancelEdit.create = function (value0) {
          return new CancelEdit(value0);
      };
      return CancelEdit;
  })();
  var renderNote = function (v) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mdc-card") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(v.title) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("note-content") ])([ Halogen_HTML_Core.text(v.content) ]) ]);
  };
  var renderNoteList = function (notes) {
      return Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderNote)(notes));
  };
  var renderCredential = function (v) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mdc-card") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(v.id) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(v.username) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(v.password) ]) ]);
  };
  var renderCredentialList = function (credentials) {
      return Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderCredential)(credentials));
  };
  var renderVaultList = function (v) {
      return function (v1) {
          if (v1 instanceof Credentials) {
              return renderCredentialList(v.credentials);
          };
          if (v1 instanceof Notes) {
              return renderNoteList(v.notes);
          };
          throw new Error("Failed pattern match at VaultComponent line 110, column 1 - line 110, column 106: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var initialState = function (vault) {
      return {
          vault: vault,
  ...
  var eqVaultView = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Credentials && y instanceof Credentials) {
              return true;
          };
          if (x instanceof Notes && y instanceof Notes) {
              return true;
          };
          return false;
      };
  ...
  var tabClass = function (tab) {
      return function (currentView) {
          return "mdc-tab" + (function () {
              var $34 = Data_Eq.eq(eqVaultView)(tab)(currentView);
              if ($34) {
  ...
  var renderVault = function (st) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.class_("mdc-tab-bar") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName(tabClass(Credentials.value)(st.vaultView))), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SwitchTab.create(Credentials.value))) ])([ Halogen_HTML_Core.text("Credentials"), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("mdc-tab__indicator") ])([  ]) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName(tabClass(Notes.value)(st.vaultView))), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SwitchTab.create(Notes.value))) ])([ Halogen_HTML_Core.text("Notes"), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("mdc-tab__indicator") ])([  ]) ]) ]), (function () {
          if (st.maybeOpenedEntry instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("mdc-button mdc-button--outlined"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(AddEntry.create)) ])([ Halogen_HTML_Core.text("Add") ]);
          };
          if (st.maybeOpenedEntry instanceof Data_Maybe.Just) {
              return Halogen_HTML_Elements.div_([  ]);
          };
          throw new Error("Failed pattern match at VaultComponent line 85, column 7 - line 90, column 29: " + [ st.maybeOpenedEntry.constructor.name ]);
      })(), (function () {
          if (st.maybeOpenedEntry instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.div_([  ]);
          };
          ...
          throw new Error("Failed pattern match at VaultComponent line 91, column 7 - line 93, column 118: " + [ st.maybeOpenedEntry.constructor.name ]);
      })(), (function () {
          if (st.maybeOpenedEntry instanceof Data_Maybe.Just) {
          ...
          throw new Error("Failed pattern match at VaultComponent line 94, column 7 - line 105, column 30: " + [ st.maybeOpenedEntry.constructor.name ]);
      })(), renderVaultList(st.vault)(st.vaultView) ]);
  };
  var render = function (st) {
      return Halogen_HTML_Elements.div_([ renderVault(st) ]);
  };
  var eqEditEntrySlot = new Data_Eq.Eq(function (x) {
      return function (y) {
          return true;
      };
  });
  var ordEditEntrySlot = new Data_Ord.Ord(function () {
      return eqEditEntrySlot;
  }, function (x) {
      return function (y) {
          return Data_Ordering.EQ.value;
      };
  });
  var addEntry = function (v) {
      return function (v1) {
          if (v instanceof Vault.CredentialEntry) {
              return Vault.Vault((function () {
                  ...
                  $47.credentials = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ v.value0 ])(v1.credentials);
                  return $47;
              })());
          };
          if (v instanceof Vault.NoteEntry) {
              return Vault.Vault((function () {
                  var $51 = {};
                  for (var $52 in v1) {
                  ...
                  $51.notes = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ v.value0 ])(v1.notes);
                  return $51;
              })());
          };
          throw new Error("Failed pattern match at VaultComponent line 117, column 1 - line 117, column 41: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var $$eval = function (query) {
      if (query instanceof SwitchTab) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              $56.vaultView = query.value0;
              $56.maybeOpenedEntry = Data_Maybe.Nothing.value;
              return $56;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(query.value1);
          });
      };
      if (query instanceof AddEntry) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              return v.vaultView;
          }))(function (v) {
              if (v instanceof Credentials) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $63.maybeOpenedEntry = new Data_Maybe.Just({
              ...
              if (v instanceof Notes) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $66.maybeOpenedEntry = new Data_Maybe.Just({
              ...
              throw new Error("Failed pattern match at VaultComponent line 144, column 5 - line 163, column 18: " + [ v.constructor.name ]);
          });
      };
      if (query instanceof SaveEntry) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqEditEntrySlot)(EditEntrySlot.value)(Halogen_Query.request(EditEntryComponent.GetVaultEntry.create)))(function (v) {
              if (v instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $73.vault = addEntry(v.value0)(v1.vault);
                          return $73;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              var $76 = {};
                              ...
                              $76.maybeOpenedEntry = Data_Maybe.Nothing.value;
                              return $76;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(query.value0);
                          });
              ...
              throw new Error("Failed pattern match at VaultComponent line 166, column 5 - line 173, column 18: " + [ v.constructor.name ]);
          });
      };
      if (query instanceof CancelEdit) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              $81.maybeOpenedEntry = Data_Maybe.Nothing.value;
              return $81;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(query.value0);
          });
      };
      throw new Error("Failed pattern match at VaultComponent line 138, column 14 - line 176, column 18: " + [ query.constructor.name ]);
  };
  var ui = function (vault) {
      return Halogen_Component.parentComponent(ordEditEntrySlot)({
          initialState: Data_Function["const"](initialState(vault)),
          render: render,
          "eval": $$eval,
  ...
  exports["ui"] = ui;
  exports["eqVaultView"] = eqVaultView;
})(PS["VaultComponent"] = PS["VaultComponent"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Api = PS["Api"];
  ...
  var Prelude = PS["Prelude"];
  var Vault = PS["Vault"];
  var VaultComponent = PS["VaultComponent"];
  var VaultSlot = (function () {
      function VaultSlot() {

      };
      VaultSlot.value = new VaultSlot();
      return VaultSlot;
  })();
  ...
  var OnKeyboard = (function () {
      function OnKeyboard(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      OnKeyboard.create = function (value0) {
          return function (value1) {
              return new OnKeyboard(value0, value1);
          };
      };
      return OnKeyboard;
  })();
  var renderLogin = function (password) {
      return function (isLoading) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mdc-text-field") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(password), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputPassword.value), Halogen_HTML_Properties.autocomplete(false), Halogen_HTML_Properties.placeholder("Master password"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetPassword.create)), Halogen_HTML_Events.onKeyUp(Halogen_HTML_Events.input(OnKeyboard.create)), Halogen_HTML_Properties.class_("mdc-text-field__input") ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("mdc-button mdc-button--outlined"), Halogen_HTML_Properties.disabled(isLoading), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(MakeRequest.create)) ])([ Halogen_HTML_Core.text("Login") ]) ]);
      };
  };
  var renderError = function (maybeError) {
      return Halogen_HTML_Elements.div_((function () {
          if (maybeError instanceof Data_Maybe.Nothing) {
              return [  ];
          };
          if (maybeError instanceof Data_Maybe.Just) {
              return [ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Error:") ]), Halogen_HTML_Elements.pre_([ Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text(maybeError.value0) ]) ]) ];
          };
          throw new Error("Failed pattern match at Component line 73, column 7 - line 80, column 12: " + [ maybeError.constructor.name ]);
      })());
  };
  var render = function (st) {
      return Halogen_HTML_Elements.div_([ (function () {
          if (st.vault instanceof Data_Maybe.Nothing) {
              return renderLogin(st.password)(st.loading);
          };
          if (st.vault instanceof Data_Maybe.Just) {
              return Halogen_HTML.slot(VaultSlot.value)(VaultComponent.ui(st.vault.value0))(Data_Unit.unit)(Data_Void.absurd);
          };
          throw new Error("Failed pattern match at Component line 85, column 7 - line 87, column 78: " + [ st.vault.constructor.name ]);
      })(), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text((function () {
          if (st.loading) {
              return "Working...";
          };
          return "";
  ...
  var loadVault = function (next) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Api.getVault(v)))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1 instanceof Data_Either.Right) {
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $24.loading = false;
                              $24.vault = new Data_Maybe.Just(v1.value0);
                              return $24;
                          });
                      };
                      if (v1 instanceof Data_Either.Left) {
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $28.loading = false;
                              $28.error = new Data_Maybe.Just(v1.value0);
                              return $28;
                          });
                      };
                      throw new Error("Failed pattern match at Component line 118, column 3 - line 120, column 63: " + [ v1.constructor.name ]);
                  })())(function () {
  ...
  var initialState = {
      ...
      vault: Data_Maybe.Nothing.value
  };
  var $$eval = function (query) {
      if (query instanceof SetPassword) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              var $33 = {};
              for (var $34 in v) {
              ...
              $33.password = query.value0;
              $33.vault = Data_Maybe.Nothing.value;
              return $33;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(query.value1);
          });
      };
      if (query instanceof MakeRequest) {
          return loadVault(query.value0);
      };
      ...
      throw new Error("Failed pattern match at Component line 102, column 14 - line 111, column 21: " + [ query.constructor.name ]);
  }; 
  var eqVaultSlot = new Data_Eq.Eq(function (x) {
      return function (y) {
          return true;
      };
  });
  var ordVaultSlot = new Data_Ord.Ord(function () {
      return eqVaultSlot;
  }, function (x) {
      return function (y) {
          return Data_Ordering.EQ.value;
  ...
  var ui = Halogen_Component.parentComponent(ordVaultSlot)({
